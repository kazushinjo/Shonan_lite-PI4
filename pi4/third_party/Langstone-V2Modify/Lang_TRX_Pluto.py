...
class Lang_TRX_Pluto(gr.top_block):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.rational_resampler_xxx_1_2 = filter.rational_resampler_ccc(1, 8, [], 0.0)
        self.rational_resampler_xxx_1_1_0 = filter.rational_resampler_ccc(1, 2, [], 0.0)
        self.rational_resampler_xxx_1_1 = filter.rational_resampler_ccc(1, 2, [], 0.0)
        self.rational_resampler_xxx_1_0_0 = filter.rational_resampler_ccc(1, 4, [], 0.0)
        self.rational_resampler_xxx_1_0 = filter.rational_resampler_ccc(1, 4, [], 0.0)
        self.rational_resampler_xxx_1 = filter.rational_resampler_ccc(1, 8, [], 0.0)
        self.rational_resampler_xxx_0 = filter.rational_resampler_ccc(11, 1, [], 0.0)
        self.pluto_source_0 = iio.fmcomms2_source_fc32(plutoip, [True, True], 0x800)
        self.pluto_source_0.set_len_tag_key('packet_len')
        self.pluto_source_0.set_frequency(Rx_LO)
        self.pluto_source_0.set_samplerate(528000)
        self.pluto_source_0.set_gain_mode(0, 'slow_attack')
        self.pluto_source_0.set_gain(0, 64)
        self.pluto_source_0.set_quadrature(True)
        self.pluto_source_0.set_rfdc(True)
        self.pluto_source_0.set_bbdc(True)
        self.pluto_source_0.set_filter_params('Auto', '', 0, 0)
        self.pluto_sink_0 = iio.fmcomms2_sink_fc32(plutoip, [True, True], 0x800, False)
        self.pluto_sink_0.set_len_tag_key('')
        self.pluto_sink_0.set_bandwidth(2000000)
        self.pluto_sink_0.set_frequency(Tx_LO)
        self.pluto_sink_0.set_samplerate(528000)
        self.pluto_sink_0.set_attenuation(0, Tx_Gain)
        self.pluto_sink_0.set_filter_params('Auto', '', 0, 0)
        self.low_pass_filter_0 = filter.fir_filter_fff(1, firdes.low_pass(
                1, 48000, 3000, 1000, window.WIN_HAMMING, 6.76))
        ...
        self.blocks_vector_to_stream_0_0 = blocks.vector_to_stream(gr.sizeof_float, 512)
        self.blocks_vector_to_stream_0 = blocks.vector_to_stream(gr.sizeof_float, 512)
        self.blocks_udp_sink_0_0 = network.udp_sink(gr.sizeof_float, 1, '127.0.0.1', 7474, 0, 2048, False)
        self.blocks_udp_sink_0 = network.udp_sink(gr.sizeof_float, 1, '127.0.0.1', 7373, 0, 2048, False)
        ...
        self.connect((self.blocks_vector_to_stream_0_0, 0), (self.blocks_udp_sink_0_0, 0))
    ...
    def set_Tx_LO(self, Tx_LO):
        self.Tx_LO = Tx_LO
        self.pluto_sink_0.set_frequency(self.Tx_LO)
    ...
    def set_Tx_Gain(self, Tx_Gain):
        ...
        self.pluto_sink_0.set_attenuation(0, self.Tx_Gain)
    ...
    def set_Rx_LO(self, Rx_LO):
        self.Rx_LO = Rx_LO
        self.pluto_source_0.set_frequency(self.Rx_LO)
